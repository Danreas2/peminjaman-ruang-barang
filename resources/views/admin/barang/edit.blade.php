  ...
  <div class="row">
    <div class="col-xl-12">
        <section class="hk-sec-wrapper">
            ...
            <div class="row">
                <div class="col-sm">
                    <form method="post" action="{{ route('admin.barang.update', $id) }}">
                        @method('PUT')
                        @csrf
                        <div class="form-group row">
                            <label for="no_inventaris" class="col-sm-2 col-form-label">No Inventaris</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="no_inventaris" name="no_inventaris" placeholder="Nomor Inventaris" value="{{ $data->no_inventaris }}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="ruang" id="ruang">
                                    ...
                                    @foreach($ruang as $r)
                                    <option value="{{ $r->id }}" @if($data->id_ruang == $r->id) selected @endif>{{ $r->nama_ruang }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="tanggal_pengadaan" name="tanggal_pengadaan" placeholder="Tanggal Pengadaan" value="{{ $data->tanggal_pengadaan }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="jumlah" class="col-sm-2 col-form-label">Jumlah Barang</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Jumlah Barang" value="{{ $data->jumlah }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="kondisi">
                                    ...
                                    <option value="hilang" @if($data->kondisi == 'hilang') selected @endif>Hilang</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="ada">
                                    ...
                                    <option value="ada"  @if($data->status == 'ada') selected @endif>Ada</option>
